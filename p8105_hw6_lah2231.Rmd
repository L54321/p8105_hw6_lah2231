...
## Proposed model with maternal height, maternal weight gain, gestational age, and presence of malformations
```{r}
...
```
I used modelr::add_predictions and modelr::add_residuals to prepare data for plotting residuals against fitted values.
...
```
I used crossv_mc to create train/test splits, fit models and calculate cross-validated RMSEs.
